...
public class SearchServiceImpl implements SearchService {
    ...
    @Autowired
    private ElasticsearchRepository<DiscussPost, Integer> searchRepository;
    ...
    public Page<DiscussPost> searchDiscussPost(String keyWord, int current, int size) {
        SearchQuery searchQuery = new NativeSearchQueryBuilder()
                ...
                .build();
        return searchTemplate.queryForPage(searchQuery, DiscussPost.class, new SearchResultMapper() {
            @Override
