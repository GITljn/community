...
public class FollowController implements CommunityConstant {
    ...
    public String getFollowees(@PathVariable("userId") int userId, PageInfo page, Model model) {
        ...
        page.setTotalRows((int) followService.findFolloweeCount(userId, ENTITY_TYPE_USER));
    ...
    public String getFollowers(@PathVariable("userId") int userId, PageInfo page, Model model) {
        User user = userService.queryById(userId);
        if (user == null) {
            throw new RuntimeException("该用户不存在!");
        }
        ...
        page.setTotalRows((int) followService.findFollowerCount(ENTITY_TYPE_USER, userId));
